...
class KPSMLStyle:
    ...
    ST_BN1_NAME = '🤖 Repo'
    ST_BN1_URL = 'https://telegram.me/cloud_station9'
    ST_BN2_NAME = 'Updates 🔥'
    ST_BN2_URL = 'https://telegram.me/cloud_station9'
...
Type {help_command} to get a list of available commands</b>'''
    ...
    ST_UNAUTH = '''<i>You Are not authorized user! Deploy your own Cloud Station Mirror-Leech bot</i>'''
